    ...
    fragments() {
        return [
            ...
            //append a single button. 
            {
                ...
                action: UIExtension.UIConsts.FRAGMENT_ACTION.APPEND,
                template:
                    '<div name="custom-control" class="new-button fv__icon-toolbar-textbox" @tooltip></div>',
                config: {
            ...
            //append a button to group list.
            {
                ...
                action: UIExtension.UIConsts.FRAGMENT_ACTION.APPEND,
                template:
                    '<div name="show-layer-button" class="new-button fv__icon-toolbar-magnifier" @tooltip ></div>',
                config: {
